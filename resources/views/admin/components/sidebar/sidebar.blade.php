                ...
                <div class="sidebar-mini-hidden-b text-center">
                    ...
                    <ul class="list-inline mt-10">
                        <li class="list-inline-item">
                            <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="{{route('admin.index')}}">J. Smith</a>
                        </li>
                        <li class="list-inline-item">
                            <!-- Layout API, functionality initialized in Codebase() -> uiApiLayout() -->
                        ...
                        <li class="list-inline-item">
                            <a class="link-effect text-dual-primary-dark" href="#" onclick="document.querySelector('.js-signOut').submit()">
